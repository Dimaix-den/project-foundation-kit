...
from bot.handlers import (
    ...
    cmd_pipeline, cmd_sheets_setup, cmd_sheets_test, cmd_test_channel, handle_message, handle_document, handle_callback,
)
...
def main():
    ...
    app.add_handler(CommandHandler("test_channel", cmd_test_channel))
